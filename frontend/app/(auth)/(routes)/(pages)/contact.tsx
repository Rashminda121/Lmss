  ...
  return (
    <div className="p-10 justify-center">
      <div className="relative flex items-center text-center mb-5 ">
        ...
        <a
          href=""
          className="shadow-gray-300 shadow-lg  p-2 md:py-3 rounded-xl absolute right-0 z-10 hover:scale-110 hover:bg-blue-100 transition-all duration-300"
        >
          <img src="/uparrow.gif" className="w-5 h-5 md:w-8 md:h-8" />
        </a>
      </div>
      <div className="flex justify-center gap-2 mb-5">
        <a
          href="https://github.com/Rashminda121"
          className="p-2 md:p-3 border-5 border border-gray-500 rounded-[99px] hover:scale-110 hover:bg-blue-100 transition-all duration-300"
        >
          <img
